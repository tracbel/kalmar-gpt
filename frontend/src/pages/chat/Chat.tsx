  ...
  const makeApiRequestWithoutCosmosDB = async (
    ...
    try {
      ...
      if (!abortController.signal.aborted) {
        let errorMessage =
          "Um erro ocorreu. Por favor, tente novamente. Se o problema persistir, entre em contato com o administrador do site.";
    ...
    try {
      ...
      if (!response?.ok) {
        let errorChatMsg: ChatMessage = {
          ...
          role: ERROR,
          content:
            "Ocorreu um erro ao gerar uma resposta. O histórico de bate-papo não pode ser salvo neste momento. Se o problema persistir, entre em contato com o administrador do site.",
          date: new Date().toISOString(),
        };
      ...
      if (appStateContext.state.isCosmosDBAvailable.cosmosDB) {
        ...
        saveToDB(
          ...
          .then((res) => {
            if (!res.ok) {
              let errorMessage =
                "Um erro ocorreu. As respostas não podem ser salvas neste momento. Se o problema persistir, entre em contato com o administrador do site.";
              let errorChatMsg: ChatMessage = {
                id: uuid(),
                role: ERROR,
                content: errorMessage,
      ...
      {showAuthMessage ? (
        ...
        <Stack horizontal className={styles.chatRoot}>
          ...
          >
            ...
            <Stack
              horizontal
              className={isMobile ? styles.chatInputMobile : styles.chatInput}
            >
              {isLoading && (
                <Stack
                  horizontal
                ...
                <CommandBarButton
                  ...
                  styles={{
                    ...
                    root: {
                      color: "#FFFFFF",
                      background:
                        "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #fbbb00 33.63%, #fac937 70.31%, #f7cd4f 100%)",
                    },
                    rootHovered: {
            ...
            <div className={styles.qrCodeFixed}>
              <QRCode value="https://kalmargpt.tracbel.com.br" size={100} />
            </div>
          </div>
